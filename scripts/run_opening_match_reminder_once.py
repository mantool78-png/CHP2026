#!/usr/bin/env python3
"""One-shot: trigger opening-match prediction reminder on production."""
...
def main() -> int:
    ...
    query = urllib.parse.urlencode({"token": token, "match_id": match_id})
    last_err: Exception | None = None
    for base in ("https://wc2026.gymacro.ru", "http://wc2026.gymacro.ru"):
        url = f"{base}/cron_opening_match_reminder.php?{query}"
        try:
