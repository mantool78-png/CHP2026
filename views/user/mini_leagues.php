...
<section class="grid two">
    ...
    <div class="card">
        ...
        <p class="muted" style="margin-top: 0.75rem;">Если друг прислал <strong>ссылку</strong>: откройте её, при необходимости войдите — затем на странице подтверждения нажмите «Вступить» (защита от ложных вступлений).</p>
    </div>
</section>
